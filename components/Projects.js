...
const Projects = () => {
  ...
  return (
    <div name="portfolio" className=" w-[1024px] max-w-full mx-auto md:h-screen py-24 sm:py-4" id="projects" >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="pb-8 sm:pb-0">
          <p id="projects" className="text-4xl text-green font-bold inline border-b-4 border-gray-500 sm:text-3xl"> 
            Projects
          </p>
